<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="index.php"><img src="assets/img/admin1.jpg" alt="Admin" class="img-responsive logo"></a>
			</div>
			<div class="container-fluid">
				...
				<div class="navbar-form navbar-left">
					<div class="pro_name">
						...
						<p style="color:#0033cc">Inventory management system</p>	
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="./setting.php"><i class="lnr lnr-cog"></i> <span>Settings</span></a></li>
