...
<div class="modal fade" id='exampleModal1_<?php echo $row['id']?>' tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					  <div class="modal-dialog" role="document">
						...
						<label for="store_name">Category Name</label>
							...
							<input type='text' class='form-control' id='store_name' name='store_name' value = '<?php echo $row['store_name']?>' autocomplete='off' required>    
						    </div>
						        <div class="form-group">
  ...
  <div class="modal fade" id='exampleModal2_<?php echo $row['id'] ?>' tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalLabel2"> DELETE STORE </h5>
					        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					          <span aria-hidden="true">&times;</span>
					        </button>
					      </div>
						 ...
						 <form action="" method="POST"> 	
							<div>
								...
								<input type='hidden' value='<?php echo $row['id'] ?>' name="id">
								<h2 class="text-center"><?php echo $row['store_name'].' '.$row['available']; ?></h2>   	
							</div>
					    <div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
