...
<?php
	if(isset($_POST['submit']) && $_POST['submit']!=''){
		...
		$brand_name = (!empty($_POST['category_name'])) ? $_POST['category_name']: '';
		$status = (!empty($_POST['avil'])) ? $_POST['avil']: '';
        
				$sql = "INSERT INTO category (category_name, available)
...
if(isset($_POST['edit']) && $_POST['edit']!=''){
	...
	$query="UPDATE category set category_name = '$category_name', available = '$status' where id ='$id'";
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">Category/Manage</h3>
						</div>
					</div>
			<!-- add main body -->
					   ...
					   //database show webpage
						...
						$result = $conn->query($query);
							while($row = $result->fetch_assoc())
							{
								...
								include('category_edit_del_modal.php');
