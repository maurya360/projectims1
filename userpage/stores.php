...
<?php
	if(isset($_POST['submit']) && $_POST['submit']!=''){
		...
		$status = (!empty($_POST['avil'])) ? $_POST['avil']: '';
				...
				$sql = "INSERT INTO store (store_name, available)
				VALUES ('$store_name', '$status')";
...
if(isset($_POST['edit']) && $_POST['edit']!=''){
	...
	$query="UPDATE store set store_name = '$store_name', available = '$status' where id ='$id'";
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">Store/Manage</h3>
						</div>
					</div>
			<!-- add main body -->
					   ...
					   //database show webpage
						...
						$result = $conn->query($query);
							while($row = $result->fetch_assoc())
							{
								...
								include('store_edit_del_modal.php');
					    ...
					    <div class="modal-content">
						  ...
						  <form action="" method="POST">
					      	<div class="form-group" >
						            ...
						            <input type="text" class="form-control" id="store_name" name="store_name" placeholder="Enter brand name" autocomplete="off" required>
						    </div>
						          	<div class="form-group">
