...
<body>
  ...
  <div class="login-html">
    <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">User/Sign In</label>
    ...
    <div class="login-form">
      ...
      <?php } ?>
        <div class="group">
          ...
          <input id="username" name="email" type="text" class="input" autocomplete="off">
